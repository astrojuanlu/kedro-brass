...
# spaceflights_pandas_yaml documentation build
...
from spaceflights_pandas_yaml import __version__ as release

# -- Project information -----------------------------------------------------

project = "spaceflights_pandas_yaml"
author = "Kedro"
...
htmlhelp_basename = "spaceflights_pandas_yamldoc"
...
latex_documents = [
    (
        master_doc,
        "spaceflights_pandas_yaml.tex",
        "spaceflights_pandas_yaml Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "spaceflights_pandas_yaml",
        "Project spaceflights_pandas_yaml codebase.",
        "Data-Science",
    )
]
